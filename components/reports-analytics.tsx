...
export function ReportsAnalytics() {
  ...
  const stats = useMemo(() => {
    ...
    const calculatedStats = orders.reduce((acc, order) => {
      acc.totalOrders += 1
    ...
    const avgOrderValue = calculatedStats.totalOrders > 0 ? calculatedStats.totalRevenue / calculatedStats.totalOrders : 0

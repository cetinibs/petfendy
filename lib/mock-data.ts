...
// Turkish cities with their districts for taxi service
export const mockTurkishCitiesWithDistricts: Record<string, string[]> = {
  "İstanbul": [
    ...
    "Silivri", "Sultangazi", "Şile", "Şişli", "Tuzla", "Ümraniye", "Üsküdar", "Zeytinburnu"
  ],
  "Ankara": [
  ...
  "Diyarbakır": [
    "Bağlar", "Bismil", "Çermik", "Çınar", "Dicle", "Eğil", "Ergani",

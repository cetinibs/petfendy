...
import { ShoppingCart, Globe, Home, Award, Scissors, Car } from "lucide-react"
...
export default function ServicesPage() {
  ...
  const switchLocale = (newLocale: string) => {
    router.push(`/${newLocale}/hizmetlerimiz`)
  }
  ...
  const services = [
    {
      ...
      description: "7/24 açık, kafessiz ve konforlu konaklama hizmetimiz ile evcil dostlarınız güvende",
      features: [
        "Kafessiz konaklama alanları",
        "7/24 veteriner hekim desteği",
        "Özel beslenme programları",
        "Günlük oyun ve aktivite saatleri",
        "Kamera ile takip imkanı",
      ],
      link: "/otel"
    },
    {
      icon: Award,
      title: "Köpek Eğitimi",
      description: "Profesyonel eğitmenler eşliğinde temel ve ileri seviye köpek eğitimi",
      features: [
        "Temel itaat eğitimi",
        "İleri seviye komutlar",
        "Sosyalleşme eğitimi",
        "Davranış problemleri çözümü",
    ...
    },
    {
      icon: Scissors,
      title: "Pet Kuaför",
      description: "Evcil hayvanlarınız için profesyonel bakım ve güzellik hizmetleri",
      features: [
        "Profesyonel tıraş ve kesim",
        "Tırnak bakımı",
        "Kulak temizliği",
        "Banyo ve fön",
        "Özel şampuan ve bakım ürünleri",
      ],
      link: "/pet-kuafor"
    },
    {
      icon: Car,
      title: "Pet Taksi",
      description: "Evcil dostlarınız için güvenli ve konforlu ulaşım hizmeti",
      features: [
        "Klimalı ve konforlu araçlar",
        "Deneyimli sürücüler",
        "Şehir içi ve şehirler arası taşıma",
        "Veteriner randevuları için transfer",
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            Petfendy olarak evcil dostlarınıza en kaliteli hizmeti sunmak için
            çalışıyoruz. Modern tesisimizde sunduğumuz hizmetlerimizi keşfedin.
          </p>
        </div>
        ...
        <div className="bg-primary/5 rounded-lg p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">Hizmetlerimiz Hakkında Bilgi Almak İster Misiniz?</h2>
